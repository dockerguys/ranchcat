...
{{- if and (eq .Values.keycloak_enable_feature_docker "true") (eq .Values.keycloak_enable_feature_js "true") }}
      KEYCLOAK_STARTUP_EXTARGS: "-Dkeycloak.profile.feature.docker=enabled -Dkeycloak.profile.feature.script=enabled ${keycloak_extarg}"
...
{{- else if eq .Values.keycloak_enable_feature_js "true" }}
      KEYCLOAK_STARTUP_EXTARGS: "-Dkeycloak.profile.feature.script=enabled ${keycloak_extarg}"
{{- else }}
